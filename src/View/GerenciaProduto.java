...
public class GerenciaProduto extends javax.swing.JFrame {
    ...
    public GerenciaProduto() {
        initComponents();
        this.objproduto = new Produto(); // inicializa o objeto
        this.carregaTabela(); // carrega a tabela ao abrir a tela
}
    ...
    private void initComponents() {
        ...
        jTableProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Descrição", "Estoque", "Preço", "Data de Cadastro"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(c_datacadastro, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(c_preco, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE))
                        .addComponent(c_descrição, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void b_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_alterarActionPerformed
        ...
        try {
            ...
            if (this.c_descrição.getText().length() <= 0) {
                throw new Mensagens("Descrição deve ser n�mero e maior que zero.");
            } else {
                descricao = this.c_descrição.getText();
            }

            if (this.c_estoque.getText().length() < 2) {
            ...
            if (this.c_preco.getText().length() <= 0) {
                throw new Mensagens("Pre deve ser n�mero e maior que zero.");
            } else {
            ...
            if (this.objproduto.UpdateProdutoBD(id, nome, descricao, estoque, preco, dataCadastro)) {
    ...
    private void jTableProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableProdutosMouseClicked
        ...
        if (this.jTableProdutos.getSelectedRow() != -1) {
            ...
            String estoque = this.jTableProdutos.getValueAt(this.jTableProdutos.getSelectedRow(), 3).toString();
            String preco = this.jTableProdutos.getValueAt(this.jTableProdutos.getSelectedRow(), 4).toString();
            String datacadastro = this.jTableProdutos.getValueAt(this.jTableProdutos.getSelectedRow(), 5).toString();

            this.c_nome.setText(nome);
            this.c_descrição.setText(descricao);
            this.c_estoque.setText(estoque);
            this.c_preco.setText(preco);
            this.c_datacadastro.setText(datacadastro);
