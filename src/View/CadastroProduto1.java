...
// Método para deixar bonito (estilo ProDesk)
    private void configurarDesign() {
        ...
        lblTitulo.setBackground(new Color(0, 102, 204)); // Azul ProDesk
        lblTitulo.setForeground(Color.WHITE);
        lblTitulo.setFont(new Font("Segoe UI", Font.BOLD, 18));
        lblTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        
        // Botões
        b_cadastrar.setBackground(new Color(0, 153, 51)); // Verde
        b_cadastrar.setForeground(Color.WHITE);
        b_cadastrar.setFont(new Font("Segoe UI", Font.BOLD, 12));
        
        b_cancelar.setBackground(new Color(204, 0, 0)); // Vermelho
        b_cancelar.setForeground(Color.WHITE);
    }
